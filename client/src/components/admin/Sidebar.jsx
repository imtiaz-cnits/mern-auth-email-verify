...
const Sidebar = () => {
    return (
        <div className="bg-[var(--adm-color-secondary)] dark:bg-[var(--adm-dark-1)]">
                    ...
                    <ul className="nav-list primary-nav">
                        ...
                        <li className="nav-item">
                            <a href="/nft-marketplace" className="nav-link">
                                ...
                                <span className="nav-label dark:text-[var(--adm-text-light)]">NFT Marketplace</span>
                            </a>
                        </li>
                    ...
                    <ul className="nav-list secondary-nav dark:!bg-[var(--adm-dark-2)]">
                        ...
                        <li className="nav-item">
                            <a href="/signout" className="nav-link">
                                <span className="w-[24px]">
                                    <i className="fa-solid fa-right-from-bracket text-[var(--adm-text-secondary)]"></i>
                                </span>
                                <span className="nav-label dark:text-[var(--adm-text-light)]">Sign Out</span>
                            </a>
                        </li>
                    </ul>
                </nav>
