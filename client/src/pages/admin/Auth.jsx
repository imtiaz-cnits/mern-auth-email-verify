            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-8 md:py-[20px] relative bg-[var(--bg)] dark:bg-[var(--dark-bg)]">
                <div className="w-full h-screen max-w-md flex flex-col items-center justify-between py-[20px]">
                    ...
                    <form className={`w-full dark:text-[var(--text-4)] main-form ${showSignup ? 'hidden' : ''}`}>
                        ...
                        <button className="google_btn w-full gap-2 flex items-center justify-star rounded-[12px] py-[10px] px-[20px] bg-[var(--secondary-color)] text-[var(--text-1)] transition duration-400 cursor-pointer">
                            <svg width="16"
                                height="16"
                                viewBox="0 0 20 20"
                                fill="none"
                        ...
                        <div className="form_grp relative">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border border-[var(--border-color2)] rounded-[12px] focus:outline-none focus:ring-1 focus:ring-[var(--primary-color)] focus:border-transparent duration-300"
                            />
                            <a href="#" className="absolute right-3 top-1/2 transform translate-y-1/4 cursor-pointer text-[var(--accent)]">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5"
                                    fill="none"
                        ...
                        <div className="flex items-center justify-between my-[20px]">
                            <div className="flex items-center">
                                ...
                                <label
                                    ...
                                    className="ml-2 text-[var(--text-1)] cursor-pointer">Keep me logged in</label>
                            </div>
                    ...
                    <div id="signup_section" className={`w-full ${showSignup ? '' : 'hidden'}`}>
                        <form className="w-full" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="form_grp mb-4">
                                <label
                                    htmlFor="name"
                                    className="block text-[var(--text-1)] font-semibold mb-2"
                                >Full Name*</label
                                >
                                <input
                                    type="text"
